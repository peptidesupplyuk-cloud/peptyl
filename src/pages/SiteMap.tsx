...
const SiteMapPage = () => (
  <div className="min-h-screen bg-background">
    <SEO
      title="Sitemap"
      description="Complete list of all pages on Peptyl, the UK peptide research platform. Browse our peptide database, educational articles, calculators, and more."
      path="/sitemap"
    />
    <Header />
