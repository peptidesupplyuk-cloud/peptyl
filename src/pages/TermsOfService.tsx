          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-10 text-muted-foreground leading-relaxed">
              ...
              <div>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">3.2 Purchaser Representations</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">3.3 Product Information</h3>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">4. Ordering and Payment</h2>

                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">4.1 Order Acceptance</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">4.2 Pricing</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">4.3 Payment</h3>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">5. Shipping and Delivery</h2>

                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">5.1 UK Shipping</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">5.2 International Shipping</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">5.3 Shipping Restrictions</h3>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">6. Returns and Refunds</h2>

                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">6.1 Return Policy</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground mt-6 mb-3">6.2 Damaged or Incorrect Orders</h3>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">11. Age Restriction</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">12. Compliance with Laws</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">13. Termination</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">14. Changes to Terms</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">15. Governing Law and Jurisdiction</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">16. Severability</h2>
              ...
              <div>
                <h2 className="text-xl font-heading font-bold text-primary mb-4">18. Contact Information</h2>
