...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Evidence-based BPC-157 dosage guide covering subcutaneous and oral protocols, typical research ranges (250-500mcg), timing, cycling, and reconstitution instructions.",
    readTime: "8 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Comparison",
    excerpt: "Comparing oral and injectable BPC-157: bioavailability, efficacy for gut vs systemic healing, dosing differences, and which route suits different research goals.",
    readTime: "7 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Safety",
    excerpt: "Comprehensive review of BPC-157 side effects from animal studies and community reports. Safety profile, contraindications, and precautions for researchers.",
    readTime: "7 min read",
    date: "March 2026",
  },
  {
    ...
    excerpt: "Complete UK guide to semaglutide (Wegovy/Ozempic): NHS access, private prescription costs, dosing schedules, side effects, and comparison with tirzepatide.",
    readTime: "10 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Comparison",
    excerpt: "Detailed comparison of tirzepatide (Mounjaro) and semaglutide (Wegovy/Ozempic): weight loss data, mechanisms, side effects, UK availability, and pricing.",
    readTime: "9 min read",
    date: "March 2026",
  },
  {
    ...
    category: "GLP-1 Guide",
    excerpt: "Research-backed strategies to prevent muscle loss during GLP-1 therapy. Protein intake, resistance training, bimagrumab, and monitoring approaches.",
    readTime: "9 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Guide",
    excerpt: "Research overview of peptides used in bodybuilding: growth hormone secretagogues, healing peptides, fat loss compounds, and tanning peptides with evidence and dosing.",
    readTime: "10 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Deep Dive",
    excerpt: "Research overview of humanin, a mitochondrial-derived peptide linked to neuroprotection, insulin sensitivity, and longevity. Mechanisms, animal data, and clinical relevance.",
    readTime: "9 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Deep Dive",
    excerpt: "Research overview of myostatin inhibitors including bimagrumab and apitegromab. Clinical trial data, muscle preservation for GLP-1 users, and market outlook.",
    readTime: "10 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Deep Dive",
    excerpt: "Research overview of FGF21: the fasting-activated hormone linked to metabolic flexibility, fat oxidation, liver health, and extended lifespan in animal models.",
    readTime: "9 min read",
    date: "March 2026",
  },
  {
    ...
    category: "Guide",
    excerpt: "Evidence-based guide to peptide stacking: which compounds synergise, how to structure multi-peptide protocols, timing considerations, and safety guidelines.",
    readTime: "8 min read",
    date: "March 2026",
  },
  {
    slug: "semax-selank-dosage-guide",
    title: "Semax and Selank Dosage Guide: Nootropic Peptides for Focus and Anxiety",
    category: "Dosing Guide",
    excerpt: "Research-based dosage guide for Semax and Selank nootropic peptides. Intranasal dosing protocols, cycling, side effects, and comparison to conventional nootropics.",
    readTime: "8 min read",
    date: "March 2026",
  },
  {
