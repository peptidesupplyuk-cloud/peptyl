...
export const peptides: PeptideData[] = [
  ...
  },
  {
    ...
    experiences: [
      ...
      { text: "Site reactions (redness/stinging) reported initially", votes: 0, sentiment: "caution", source: "Community reports" },
    ],
  },
  {
    name: "GHRP-2",
  ...
  },
  {
    ...
    experiences: [
      ...
      { text: "Mild site irritation reported by some", votes: 0, sentiment: "caution", source: "Community reports" },
    ],
  },
  {
    name: "Hexarelin",
  ...
  },
  {
    ...
    experiences: [
      ...
      { text: "Site redness is common but resolves quickly", votes: 0, sentiment: "caution", source: "Community reports" },
    ],
  },
  {
    name: "Melanotan II",
  ...
  },
  {
    ...
    category: "Weight Management",
    description: "First-in-class triple agonist targeting GLP-1, GIP, and glucagon receptors. Phase III data shows ~28.7% body weight reduction. FDA submission expected 2027. Oral formulation in early development.",
    icon: Flame,
    administration: "SubQ",
    frequency: "Once weekly",
    ...
    cycleDuration: "12+ weeks",
    isNew: true,
    benefits: ["Weight loss (up to 28.7%)", "Triple-action", "Metabolic health"],
    regulatoryStatus: {
      us: { status: "trial", phase: "Phase III" },
      eu: { status: "trial", phase: "Phase III" },
    },
    experiences: [
      { text: "Up to 28.7% body weight reduction confirmed in Phase III trials", votes: 0, sentiment: "positive", source: "Phase III clinical trial (Dec 2025)" },
  ...
  },
  {
    ...
    category: "Weight Management",
    description: "FDA-approved GLP-1 analog that reduces appetite, slows gastric emptying, and improves glycaemic control. Available as weekly injection (Ozempic/Wegovy) and daily oral pill (Rybelsus/Wegovy oral — FDA-approved Dec 2025).",
    icon: Flame,
    administration: "SubQ/Oral",
    frequency: "Once weekly (SubQ) / Daily (Oral)",
    doseRange: "0.25-2.4 mg/week (SubQ) / 3-14 mg/day (Oral)",
    cycleDuration: "Ongoing",
    notes: "Oral: take on empty stomach with ≤4 oz water, 30 min before food. SubQ: start lowest dose, increase every 4 weeks",
    benefits: ["Weight loss (15-17%)", "Appetite control", "Blood sugar", "Oral option available"],
    regulatoryStatus: {
      us: { status: "approved", label: "Approved (Ozempic/Wegovy — SubQ & Oral)" },
      eu: { status: "approved", label: "Approved (Ozempic/Wegovy)" },
      uk: { status: "approved", label: "Approved (Ozempic/Wegovy)" },
    },
    experiences: [
      { text: "Average 15% body weight reduction in STEP trials (SubQ)", votes: 0, sentiment: "positive", source: "STEP clinical trials" },
      { text: "Oral Wegovy approved Dec 2025 — ~17% weight loss in OASIS 4 trial", votes: 0, sentiment: "positive", source: "OASIS 4 Phase III trial" },
      { text: "Oral form requires strict fasting protocol for absorption", votes: 0, sentiment: "caution", source: "Prescribing information" },
  ...
  },
  {
    ...
    category: "Weight Management",
    description: "FDA-approved dual agonist. SURMOUNT trials demonstrated up to 21% body weight reduction. Oral formulation in Phase III trials (expected 2026-2027).",
    icon: Flame,
    administration: "SubQ (Oral in trials)",
    frequency: "Once weekly",
    doseRange: "2.5-15 mg/week",
    cycleDuration: "Ongoing",
    benefits: ["Weight loss (up to 21%)", "Dual-action", "Blood sugar", "Oral in development"],
    regulatoryStatus: {
    ...
    experiences: [
      ...
      { text: "Oral tirzepatide in Phase III trials — FDA submission expected 2026-2027", votes: 0, sentiment: "positive", source: "Eli Lilly pipeline" },
  ...
  },
  {
    ...
    category: "Anti-Aging & Skin",
    description: "Master antioxidant produced by every cell. SubQ form bypasses poor oral bioavailability. Supports detoxification, immune function, and skin brightening.",
    icon: Sparkles,
    administration: "SubQ/IM/IV",
    frequency: "2-3x weekly",
  ...
  },
  {
    ...
    experiences: [
      { text: "Extended half-life provides sustained GH elevation — fewer doses needed", votes: 0, sentiment: "positive", source: "Pharmacokinetics" },
  ...
  },
  {
    ...
    category: "Weight Management",
    description: "FDA-approved GLP-1 analog with shorter half-life than semaglutide. Requires daily dosing. Proven efficacy for weight management and type 2 diabetes.",
    icon: Flame,
    administration: "SubQ",
    frequency: "Daily",
    ...
    experiences: [
      ...
      { text: "Requires daily dosing — less convenient than weekly semaglutide", votes: 0, sentiment: "neutral", source: "Prescribing information" },
    ],
  },
  {
    name: "5-Amino-1MQ",
  ...
  },
  {
    ...
    experiences: [
      ...
      { text: "Very short half-life (~5 min) — must administer immediately post-training", votes: 0, sentiment: "caution", source: "Pharmacokinetics" },
    ],
  },
  {
    name: "PEG-MGF",
