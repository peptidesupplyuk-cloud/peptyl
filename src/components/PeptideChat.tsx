      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[5rem] right-3 z-40 w-[320px] max-w-[calc(100vw-1.5rem)] h-[420px] max-h-[calc(100vh-7rem)] flex flex-col bg-card border border-border rounded-2xl shadow-xl overflow-hidden md:bottom-6 md:right-4 md:w-[340px] md:h-[480px] md:max-h-[calc(100vh-6rem)]"
          >
            {/* Header */}
