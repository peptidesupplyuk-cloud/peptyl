...
const productConfig: Record<string, { amount: number; description: string; redirectPath: string }> = {
  ...
  dna_standard: { amount: 1499, description: "Peptyl DNA Standard Assessment", redirectPath: "/dna/upload?tier=standard" },
  dna_advanced: { amount: 2999, description: "Peptyl DNA Advanced Assessment", redirectPath: "/dna/upload?tier=advanced" },
  dna_pro: { amount: 5999, description: "Peptyl DNA Pro Assessment", redirectPath: "/dna/upload?tier=pro" },
